...
const ProgramKerja = () => {
	...
	const renderAddPopup = () => (
		...
		<div className="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-xl">
			...
			{[
			{ label: "Nama Program Kerja", name: "program", type: "text", placeholder: "Nama Program" },
			{ label: "Tempat", name: "tempat", type: "text", placeholder: "Tempat" },
			{ label: "Dana", name: "dana", type: "number", placeholder: "Nominal Dana" },
			{ label: "Realisasi", name: "realisasi", type: "text", placeholder: "Realisasi" },
			{ label: "Tanggal Mulai", name: "start_date", type: "date", placeholder: "Tanggal Mulai" },
			{ label: "Tanggal Selesai", name: "end_date", type: "date", placeholder: "Tanggal Selesai" },
	...
	/>
			...
			<button onClick={() => setAddPopup(false)} className="px-4 py-2 bg-gray-300 rounded">
				Batal
			</button>
			<button onClick={handleAddSubmit} className="px-4 py-2 bg-greenPrimary text-white rounded">
				Tambah
			</button>
			</div>
